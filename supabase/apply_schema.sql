-- Full schema for Supabase. Apply in SQL Editor in order (this file is already ordered).
-- Order: users -> devices -> challenges -> groups (+ group_members) -> group_seq, messages, send_message
...
-- 4. groups + group_members (group_members references devices)
...
-- 5. group_seq, messages, send_message
