      ...
      try {
        ...
        try {
          ...
          if (String(addErr).includes('DuplicateSignatureKey')) {
            // Already added by processPendingInvites running in parallel — treat as done.
        ...
        // Deliver welcome to server (include commit so other members can stay in epoch sync)
